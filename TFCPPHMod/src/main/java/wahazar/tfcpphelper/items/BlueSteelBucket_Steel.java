...
public class BlueSteelBucket_Steel  extends Item implements ISize 
{
	public BlueSteelBucket_Steel()
	{
		super();
		this.maxStackSize = 1;
		this.setCreativeTab(TFCTabs.TFC_MISC);
		this.hasSubtypes = false;
		this.setUnlocalizedName("BlueSteelBucket_Steel");
	}
	...
	{
		this.itemIcon = registerer.registerIcon(TFCPPDetails.ModID+":"+"itemBlueSteelBucket_Steel");
	}
	...
	public boolean tryPlaceContainedLiquid(World world, int x, int y, int z)
	{
		...
		if (!world.isAirBlock(x, y, z) && !flag)
		...
		else
			{
				...
				Block moltenMetal;
				moltenMetal = GameRegistry.findBlock("foundry", "liquidSteel");
				if (moltenMetal!=null)
