...
public class TransferLadle_BlackSteel extends BlockTerra
{
    ...
    public TransferLadle_BlackSteel()
    {
        super(Material.iron);
        this.setBlockName("TransferLadle_BlackSteel");
...
public void onBlockPlacedBy(World w_, int x_, int y_, int z_, EntityLivingBase player, ItemStack is_)
{
    ...
    public void registerBlockIcons(IIconRegister register)
    {
        ...
        _icontop = register.registerIcon(baseName + "TransferLadle_Top_BlackSteel");
    }
