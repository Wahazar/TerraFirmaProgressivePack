...
public class BlockPotionsLiquid extends BlockFluidClassic implements IFluidBlock
{
	protected IIcon[] icons;
	protected String fluidName;
	protected int potId;
	protected int potTime;

	public BlockPotionsLiquid(String fluidname, int potid, int pottime)
	{
	...
	public void onEntityCollidedWithBlock(World world, int x, int y, int z, Entity entity) 
	{
		if (entity instanceof EntityLivingBase)
		{
			...
			e.addPotionEffect(new PotionEffect(potId, potTime, 4));
		}
		return;
	}
