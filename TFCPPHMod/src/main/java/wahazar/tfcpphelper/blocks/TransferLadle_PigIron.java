...
public class TransferLadle_PigIron extends BlockTerra
{
    ...
    public TransferLadle_PigIron()
    {
        super(Material.iron);
        this.setBlockName("TransferLadle_PigIron");
        this.setHardness(0.6f);
        this.setResistance(20.0f);
		this.setLightLevel(0.6F);
        this.setCreativeTab(TFCTabs.TFC_DEVICES);       
	    this._moltenMetal = TFCPPBlocks.moltenPigIron;
    }
...
public void onBlockPlacedBy(World w_, int x_, int y_, int z_, EntityLivingBase player, ItemStack is_)
{
    ...
    public void registerBlockIcons(IIconRegister register)
    {
        ...
        _icontop = register.registerIcon(baseName + "TransferLadle_Top_PigIron");
    }
