...
public class MetalBlock_BlackSteel extends BlockTerra
{
    @SideOnly(Side.CLIENT)
    private IIcon _blockicon;
       
    public MetalBlock_BlackSteel(String unlocalizedname)
    {
        super(Material.iron);
    ...
    public void registerBlockIcons(IIconRegister register)
    {
        ...
        _blockicon = register.registerIcon(baseName + "metalBlock_BlackSteel");
    }
