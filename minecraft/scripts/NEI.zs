...
//traincraft
NEI.hide(<tc:assemblyTableI>);
NEI.hide(<tc:assemblyTableII>);
NEI.hide(<tc:assemblyTableIII>);
NEI.hide(<tc:steel>);
NEI.hide(<tc:ingotCopper>);
NEI.hide(<tc:graphite>);
NEI.hide(<tc:pants_suit_paintable>);
NEI.hide(<tc:boots_suit_paintable>);
NEI.hide(<tc:helmet_suit_paintable>);
NEI.hide(<tc:jacket_suit_paintable>);
NEI.hide(<tc:openFurnaceIdle>);
NEI.hide(<tc:waterWheel>);
NEI.hide(<tc:windMill>);
NEI.hide(<tc:reinforcedPlates>);
NEI.hide(<tc:distilIdle>);
NEI.hide(<tc:minecartFreightCartSmall>);
NEI.hide(<tc:minecartGS4_Passenger>);
NEI.hide(<tc:minecartIC4_DSB_FH>);
NEI.hide(<tc:minecartICE1_2ndClass>);
NEI.hide(<tc:minecartPassengerHighSpeedCarZeroED>);
NEI.hide(<tc:minecartGS4_Observatory>);
NEI.hide(<tc:minecartICE1_Restaurant>);
NEI.hide(<tc:minecartGrain>);
NEI.hide(<tc:minecartTenderC62Class>);
NEI.hide(<tc:minecartLocoC62Class>);
NEI.hide(<tc:minecartFreightCart2>);
NEI.hide(<tc:minecartOpenWagon>);
NEI.hide(<tc:minecartFreightClosed>);
NEI.hide(<tc:minecartFreightHopperUS>);
NEI.hide(<tc:minecartFreightCenterBeam_Empty>);
NEI.hide(<tc:minecartFreightCenterBeam_Wood_2>);
NEI.hide(<tc:minecartCabooseLoggingPRR>);
NEI.hide(<tc:minecartGS4_Tail>);
NEI.hide(<tc:minecartGS4_Baggage>);
NEI.hide(<tc:minecartFreightGTNG>);
NEI.hide(<tc:minecartFreightCartUS>);
NEI.hide(<tc:minecartFreightCenterBeam_Wood_1>);
NEI.hide(<tc:minecartFreightCart2>);
NEI.hide(<tc:minecartBoxCartUS>);
NEI.hide(<tc:minecartChest>);
NEI.hide(<tc:minecartFlatCartWoodUS>);
NEI.hide(<tc:minecartFlatCart>);
NEI.hide(<tc:minecartFlatCartSU>);
NEI.hide(<tc:minecartFlatCartUS>);
NEI.hide(<tc:minecartStockCar>);
NEI.hide(<tc:minecartDRWGStockCar>);
NEI.hide(<tc:minecartTankWagon2>);
NEI.hide(<tc:minecartTankWagonUS>);
NEI.hide(<tc:minecartLocoEMDF7B>);
NEI.hide(<tc:minecartBoxCartPRR>);
NEI.hide(<tc:minecartFreightOpen2>);
NEI.hide(<tc:minecartFreightWellcar>);
NEI.hide(<tc:minecartFreightTrailer>);
NEI.hide(<tc:minecartFreightWood2>);
NEI.hide(<tc:minecartPassengerTramNY>);
NEI.hide(<tc:minecartPassenger7>);
NEI.hide(<tc:minecartPassenger5>);
NEI.hide(<tc:minecartPassengerBlue>);
NEI.hide(<tc:minecartLocoBR01_DB>);
NEI.hide(<tc:minecartLocomogulBlue>);
NEI.hide(<tc:minecartGS4_Loco>);
NEI.hide(<tc:minecartLocoSteamClimax>);
NEI.hide(<tc:minecartLocoEr>);
NEI.hide(<tc:minecartLocoCoranationClass>);
NEI.hide(<tc:minecartLocoA4Mallard>);
NEI.hide(<tc:minecartLocoForneyRed>);
NEI.hide(<tc:minecartLocoSteam040vb>);
NEI.hide(<tc:minecartLocoSteamShay>);
NEI.hide(<tc:minecartPower>);
NEI.hide(<tc:minecartLocoDeltic>);
NEI.hide(<tc:minecartLocoSD70>);
NEI.hide(<tc:minecartChmE3>);
NEI.hide(<tc:minecartGP7Red>);
NEI.hide(<tc:minecartLocoEMDF7>);
NEI.hide(<tc:minecartLocoEWSClass66>);
NEI.hide(<tc:minecartMILW_H1044>);
NEI.hide(<tc:minecartLocoSD40>);
NEI.hide(<tc:minecartNYTram>);
NEI.hide(<tc:minecartLocoEMDF3B>);
NEI.hide(<tc:minecartLocoEMDF3>);
NEI.hide(<tc:minecartCD742>);
NEI.hide(<tc:minecartIC4_DSB_FG>);
NEI.hide(<tc:minecartIC4_DSB_MG>);
NEI.hide(<tc:minecartICE1_1stClass>);
NEI.hide(<tc:minecartCabooseWork>);
NEI.hide(<tc:minecartLocoClass85>);
NEI.hide(<tc:minecartTramWood>);
NEI.hide(<tc:minecartBR_E69>);
NEI.hide(<tc:minecartLocoBR185>);
NEI.hide(<tc:minecartVL10>);
NEI.hide(<tc:minecartLocoHighSpeedZeroED>);
NEI.hide(<tc:minecartICE1_Loco>);
NEI.hide(<tc:minecartTenderBR01_DB>);
NEI.hide(<tc:minecartTenderEr>);
NEI.hide(<tc:minecartLocoA4MallardTender>);
NEI.hide(<tc:minecartLocoCoranationClassTender>);
NEI.hide(<tc:minecartLocoBR185>);
NEI.hide(<tc:minecartGS4_Tender>);
NEI.hide(<tc:minecartTenderHeavy>);
NEI.hide(<tc:minecartMILW_H1044>);
NEI.hide(<tc:minecartSteamRedTender>);
NEI.hide(<tc:minecartSteamRedTender>);
